                ...
                <div class="card" style="margin-top: 0 !important;">
                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="d-grid d-md-none mb-3"
                            style="grid-template-columns: repeat(5, 1fr); display: grid; gap: 8px;">
                            ...
                            <button type="button" wire:click="setTab('impresion')"
                            ...
                            <button type="button" wire:click="setTab('whatsapp')"
                            ...
                            <button type="button" wire:click="setTab('modulos')"
                            ...
                            <button type="button" wire:click="setTab('importacion')"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="card border shadow-sm h-100">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        <label class="form-label fw-semibold">Nombre de la
                                                            Tienda</label>
                                                        <input type="text" class="form-control"
                                                            wire:model="nombre_tienda" wire:blur="guardarGeneral"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            wire:model="direccion" wire:blur="guardarGeneral"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    wire:model="telefono" wire:blur="guardarGeneral"
                                                        ...
                                                        <div class="col-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    wire:model="nit" wire:blur="guardarGeneral"
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        <label class="form-label fw-semibold">Nombre del
                                                            Propietario</label>
                                                        <input type="text" class="form-control"
                                                            wire:model="propietario_nombre" wire:blur="guardarGeneral"
                                                    ...
                                                    <div class="mb-0">
                                                        <label class="form-label fw-semibold">Celular del
                                                            Propietario</label>
                                                    ...
                                                    <div class="mb-0">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" step="0.01" class="form-control"
                                                                wire:model="sueldo_base" wire:blur="guardarGeneral"
                                                                placeholder="0.00">
                                                        </div>
                                                        <small class="text-muted">Sueldo base mensual para
                                                            cálculos</small>
                                                        @error('sueldo_base')
                                                            <span class="text-danger small">{{ $message }}</span>
                                                        @enderror
                                    ...
                                    async enviarAgente(agentUrl, job, successMsg) {
                                        ...
                                        try {
                                            ...
                                            if (res.ok) {
                                                ...
                                                const txt = await res.text().catch(() => 'Respuesta no válida');
                                                Swal.fire({ icon: 'error', title: 'Error del agente', text: txt });
                                            }
                                        } catch (err) {
                                            ...
                                            <div class="card shadow-sm border-0 rounded-3 overflow-hidden">
                                                ...
                                                <div class="card-header d-flex align-items-center gap-2 py-3 px-4"
                                                    ...
                                                    <div>
                                                        ...
                                                        <small class="text-white-50">Servicio local de
                                                            impresión</small>
                                                    </div>
                                                </div>
                                                ...
                                                @php
                                                    ...
                                                    $dlIOS =
                                                        !$dlAndroid && (bool) preg_match('/iphone|ipad|ipod/i', $ua);
                                                    $dlWindows =
                                                        !$dlAndroid && !$dlIOS && (bool) preg_match('/windows/i', $ua);
                                                ...
                                                <div class="px-4 pt-3 pb-2 d-flex flex-column gap-2">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <i class="fa-solid fa-circle-dot text-success"
                                                            style="font-size:.7rem;"></i>
                                                        <span
                                                            class="text-muted small font-monospace">{{ $printAgentUrl }}</span>
                                                    </div>
                                                ...
                                                <div class="px-4 pt-3 pb-1 border-top mt-1">
                                                    ...
                                                    <div class="input-group input-group-sm mb-2">
                                                        <input :type="mostrar ? 'text' : 'password'"
                                                            ...
                                                            placeholder="Clave AES-256 hex (64 chars)" maxlength="64">
                                                        <button class="btn btn-outline-secondary" type="button"
                                                            @click="mostrar = !mostrar" title="Mostrar / ocultar">
                                                            <i
                                                                :class="mostrar ? 'fa-solid fa-eye-slash' : 'fa-solid fa-eye'"></i>
                                                        </button>
                                                        <button class="btn btn-outline-secondary" type="button"
                                                    ...
                                                    @enderror
                                                    <button
                                                        class="btn btn-warning btn-sm w-100 d-flex align-items-center justify-content-center gap-2 mb-3"
                                                ...
                                                <div class="card-footer bg-light border-top px-4 py-3">
                                                    <p class="text-uppercase text-muted fw-bold mb-2"
                                                        style="font-size:.65rem;letter-spacing:.1em;">Pruebas de
                                                        impresión</p>
                                        ...
                                        <div class="col-12 col-xl-8">
                                            <div class="card shadow-sm border-0 rounded-3 overflow-hidden">
                                                <div class="card-header d-flex align-items-center gap-2 py-3 px-4"
                                                    ...
                                                    <div>
                                                        <h6 class="mb-0 text-white fw-bold">Configuración del Ticket
                                                        </h6>
                                                        <small class="text-white-50">Impresora, papel y
                                                            opciones</small>
                                                    </div>
                                                </div>
                                                <div class="card-body px-4 py-4">
                                                    ...
                                                    <div class="row g-3 mb-4">
                                                        @foreach ([['field' => 'mostrar_logo', 'label' => 'Logo', 'desc' => 'Imprimir el logo de la empresa', 'icon' => 'fa-image', 'color' => 'text-primary'], ['field' => 'corte_automatico', 'label' => 'Corte automático', 'desc' => 'Cortar el papel al finalizar', 'icon' => 'fa-scissors', 'color' => 'text-danger'], ['field' => 'abrir_cajon', 'label' => 'Abrir cajón', 'desc' => 'Pulso eléctrico al imprimir venta', 'icon' => 'fa-cash-register', 'color' => 'text-success']] as $opt)
                                                            <div class="col-12 col-sm-4">
                                                                <div
                                                                    class="border rounded-3 p-3 h-100 d-flex align-items-center justify-content-between gap-3 bg-light bg-opacity-50">
                                                                    <div class="d-flex align-items-center gap-3">
                                                                        <div class="rounded-circle bg-white shadow-sm d-flex align-items-center justify-content-center"
                                                                            ...
                                                                            <i
                                                                                class="fa-solid {{ $opt['icon'] }} {{ $opt['color'] }}"></i>
                                                                        </div>
                                                                        <div>
                                                                            <p class="mb-0 fw-semibold text-dark"
                                                                                ...
                                                                                {{ $opt['label'] }}</p>
                                                                            <small
                                                                                class="text-muted">{{ $opt['desc'] }}</small>
                                                                        </div>
                                                                    </div>
                                                                    <div
                                                                        class="form-check form-switch mb-0 flex-shrink-0">
                                                                ...
                                                                @if (ventasHabilitados())
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <div
                                                                                class="form-check form-switch d-inline-block mb-0">
                                                                                <input class="form-check-input"
                                                                                    type="checkbox" role="switch"
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <span
                                                                                class="d-flex align-items-center gap-2">
                                                                                <i
                                                                                    class="fa-solid fa-hand-holding-dollar text-warning"></i>
                                                                                <span
                                                                                    class="fw-semibold">Préstamos</span>
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text"
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <span
                                                                                class="d-flex align-items-center gap-2">
                                                                                <i
                                                                                    class="fa-solid fa-boxes-stacked text-info"></i>
                                                                                <span
                                                                                    class="fw-semibold">Inventario</span>
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text"
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <span
                                                                                class="d-flex align-items-center gap-2">
                                                                                <i
                                                                                    class="fa-solid fa-truck-ramp-box text-secondary"></i>
                                                                                <span
                                                                                    class="fw-semibold">Compras</span>
                                                                            </span>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center pb-3 mb-3"
                                                        ...
                                                        <div>
                                                            ...
                                                            <small class="text-muted">Si está desactivado, el menú de
                                                                Ventas desaparece y no se puede vender.</small>
                                                        </div>
                                                        <div class="form-check form-switch mb-0 ms-3">
                                                            <input class="form-check-input" type="checkbox"
                                                                role="switch" wire:model="ventas_enabled"
                                                                wire:change="guardarModulos" id="ventasEnabled"
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <small class="text-muted">
                                                                    Oculta los campos de medida, cantidad y precio por
                                                                    mayor.
                                                                    Todas las ventas se realizan por unidad al precio
                                                                    menor.
                                                                </small>
                                                            </div>
                                                            <div class="form-check form-switch mb-0 ms-3">
                                                                <input class="form-check-input" type="checkbox"
                                                                    role="switch" wire:model="ventas_solo_unidad"
                                                                    wire:change="guardarModulos" id="ventasSoloUnidad"
                                                                    style="width: 3rem; height: 1.5rem;">
                                                            </div>
                                                        </div>
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            <div>
                                                                <p class="fw-semibold mb-0">Empezar por unidad al
                                                                    agregar</p>
                                                                <small class="text-muted">
                                                                    Al agregar un producto al carrito inicia con 1
                                                                    unidad
                                                            ...
                                                            <div class="form-check form-switch mb-0 ms-3">
                                                                <input class="form-check-input" type="checkbox"
                                                                    role="switch" wire:model="ventas_iniciar_unidad"
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                                            <p class="fw-semibold mb-0">Habilitar compras y control de
                                                                stock</p>
                                                            <small class="text-muted">
                                                                Si está desactivado, el menú de Compras y Kardex
                                                                desaparece.
                                                                Las ventas no verificarán ni modificarán el stock de
                                                                productos.
                                                            </small>
                                                        </div>
                                                        <div class="form-check form-switch mb-0 ms-3">
                                                            <input class="form-check-input" type="checkbox"
                                                                role="switch" wire:model="compras_enabled"
                                                                wire:change="guardarModulos" id="comprasEnabled"
                                                                style="width: 3rem; height: 1.5rem;">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card border shadow-sm h-100">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-3">
                                                        <div>
                                                            <p class="fw-semibold mb-0">Habilitar módulo de préstamos
                                                            </p>
                                                            <small class="text-muted">Si está desactivado, la opción no
                                                                aparecerá en el menú ni en el header.</small>
                                                        </div>
                                                        <div class="form-check form-switch mb-0 ms-3">
                                                            <input class="form-check-input" type="checkbox"
                                                                role="switch" wire:model="prestamos_enabled"
                                                                wire:change="guardarModulos" id="prestamosEnabled"
                                                                style="width: 3rem; height: 1.5rem;">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        <label class="form-label fw-semibold">Categoría de productos
                                                            para préstamos</label>
                                                        ...
                                                        <small class="text-muted">Solo se mostrarán productos de esta
                                                            categoría al agregar ítems al préstamo.</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card border shadow-sm h-100">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div>
                                                            <p class="fw-semibold mb-0">Habilitar módulo de hospedajes
                                                            </p>
                                                            <small class="text-muted">
                                                                Activa el control de habitaciones, check-in/check-out y
                                                        ...
                                                        <div class="form-check form-switch mb-0 ms-3">
                                                            <input class="form-check-input" type="checkbox"
                                                                role="switch" wire:model="hospedajes_enabled"
                                                                wire:change="guardarModulos" id="hospedajesEnabled"
                                                                style="width: 3rem; height: 1.5rem;">
                                                        </div>
                                                    </div>
                                                    ...
                                                    @if ($hospedajes_enabled)
                                                        <div class="mt-3 pt-3 border-top">
                                                            <p class="small text-muted mb-2"><i
                                                                    class="fa-solid fa-circle-info me-1"></i>Módulo
                                                                habilitado. Accede desde el menú lateral:</p>
                                                            <div class="d-flex flex-wrap gap-2">
                                                                <a href="{{ route('habitaciones') }}"
                                                                    class="btn btn-sm btn-outline-primary">
                                                                    <i class="fa-solid fa-door-open me-1"></i>Panel de
                                                                    Habitaciones
                                                                </a>
                                                                <a href="{{ route('hospedajes') }}"
                                                                    class="btn btn-sm btn-outline-secondary">
                                                                    <i
                                                                        class="fa-solid fa-clipboard-list me-1"></i>Historial
                                                                </a>
                                                                <a href="{{ route('tipos-habitacion') }}"
                                                                    class="btn btn-sm btn-outline-secondary">
                                                                    <i class="fa-solid fa-layer-group me-1"></i>Tipos y
                                                                    Tarifas
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="card border border-danger shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    <div
                                                        ...
                                                        <div>
                                                            <p class="fw-semibold mb-1 text-danger">Resetear todos los
                                                                datos de movimiento</p>
                                                            <small class="text-muted">
                                                                Elimina permanentemente todas las ventas, compras,
                                                                préstamos, hospedajes,
                                                                inventarios, movimientos y kardex de este tenant. Los
                                                                productos, categorías, clientes
                                                                y configuración <strong>no</strong> se eliminan.
                                                                <br><strong class="text-danger">Esta acción no se puede
                                                                    deshacer.</strong>
                                                            </small>
                                                        </div>
                                                    ...
                                                    <div
                                                        class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                                                        <div>
                                                            <p class="fw-semibold mb-1 text-danger">Resetear stock de
                                                                productos</p>
                                                            <small class="text-muted">
                                                                Pone en <strong>0</strong> el stock de todos los
                                                                productos de este tenant.
                                                                Útil para empezar un conteo desde cero sin borrar el
                            ...
                            @if ($activeTab === 'importacion')
                                <div class="tab-pane fade show active">
                                    <div class="alert alert-warning mb-4">
                                        ...
                                        <strong>Atención:</strong> La importación de datos reemplazará información
                                        existente. Asegúrate de tener un respaldo antes de importar.
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card border shadow-sm">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        <label class="form-label fw-semibold">Formato de Archivo
                                                            Preferido</label>
    ...
    @script
        <script>
            $wire.$watch('activeTab', value => {
                document.cookie =
                    `config_active_tab=${encodeURIComponent(value)}; path=/; max-age=31536000; SameSite=Lax`;
            });
