<header class="page-header row">
    <div class="logo-wrapper d-flex align-items-center col-auto p-0">
        <a href="/">
            <img class="light-logo img-fluid" src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="logo"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->isSuperAdmin()): ?>
            <a href="<?php echo e(route('admin.home')); ?>" class="btn btn-mode-switch ms-2"
...
[$__name, $__params] = $__split('venta-cart');

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2443380249-0', $key);
...
[$__name, $__params] = $__split('compra-cart');

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2443380249-1', $key);
...
[$__name, $__params] = $__split('prestamo-cart');

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2443380249-2', $key);
...
?>
                ...
                <li class="profile-nav">
                    <div class="user-img" id="toggleProfileSidebar" style="cursor: pointer;">
                        <img id="headerAvatar" src="<?php echo e(Auth::user()->photo_url); ?>" alt="user"
...
<?php /**PATH C:\laragon\www\licos\resources\views/layouts/tenant/header.blade.php ENDPATH**/ ?>