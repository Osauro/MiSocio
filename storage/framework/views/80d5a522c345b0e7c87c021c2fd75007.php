...
<head>
    ...
    <title><?php echo e(config('app.name', 'LicoPOS')); ?></title>
    <!-- Favicon icon-->
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('assets/css/vendors/weather-icons/weather-icons.min.css')); ?>" />
...
<?php endif; ?>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper" x-data>
        ...
        <?php echo $__env->make('layouts.tenant.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <div class="page-body-wrapper">
            ...
            <!-- Page sidebar start-->
            <?php echo $__env->make('layouts.tenant.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <!-- Page sidebar end-->
...
[$__name, $__params] = $__split('perfil-usuario');

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-440625474-0', $key);
...
[$__name, $__params] = $__split('tenant-selector');

$key = null;
$__componentSlots = [];

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-440625474-1', $key);
...
?>
    ...
    <!-- bootstrap js-->
    <script src="<?php echo e(asset('assets/js/vendors/bootstrap/dist/js/bootstrap.bundle.min.js')); ?>" defer=""></script>
    <script src="<?php echo e(asset('assets/js/vendors/bootstrap/dist/js/popper.min.js')); ?>" defer=""></script>
    <!--fontawesome-->
...
<?php /**PATH C:\laragon\www\licos\resources\views/layouts/tenant/theme.blade.php ENDPATH**/ ?>