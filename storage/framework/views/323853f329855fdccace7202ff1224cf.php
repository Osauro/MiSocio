<div>
    ...
    <div class="tenant-selector-overlay" wire:click="close">
        <div class="overlay-content" wire:click.stop>
            ...
            <div class="tenants-grid" data-count="<?php echo e(count($tenants)); ?>">
                ...
                <button type="button"
                        class="tenant-btn <?php echo e($tenant->id == $currentTenantId ? 'active' : ''); ?>"
                        wire:click="selectTenant(<?php echo e($tenant->id); ?>)"
                        wire:loading.attr="disabled"
                        style="--tenant-color: <?php echo e(getThemeColor($tenant->theme_number)); ?>;">

                    <div class="tenant-btn-header" style="background: <?php echo e(getThemeColor($tenant->theme_number)); ?>;">
                        <i class="fa-solid fa-store-alt"></i>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->id == $currentTenantId): ?>
                        <span class="active-indicator">
                            <i class="fa-solid fa-circle-check"></i>
                        </span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <div class="loading-spinner" wire:loading wire:target="selectTenant(<?php echo e($tenant->id); ?>)">
                    ...
                    <div class="tenant-btn-body">
                        ...
                        <span class="tenant-role-badge">
                            ...
                            <?php echo e(ucfirst($tenant->pivot->role)); ?>
...
<?php /**PATH C:\laragon\www\licos\resources\views/livewire/tenant-selector.blade.php ENDPATH**/ ?>