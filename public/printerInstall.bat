...
:: ============================================================
:: PASO 7: Crear archivos de inicio automático y desinstalación
:: ============================================================
echo.
...
echo.
echo :: ============================================================
echo :: MiSocio Printer - Inicio Automatico con Actualizacion
echo :: Se ejecuta al iniciar Windows de forma silenciosa
echo :: ============================================================
echo.
...
echo.
echo :: Crear archivo de log
echo echo [%%date%% %%time%%] Iniciando MiSocio Printer... ^>^> "%%LOG_FILE%%"
echo.
echo :: Verificar que existe la instalacion
...
echo.
echo :: ============================================================
echo :: FASE 1: Buscar actualizaciones con Git
echo :: ============================================================
...
echo.
echo             :: Actualizar dependencias si composer.json cambio
...
echo.
echo :: ============================================================
echo :: FASE 2: Verificar si ya esta ejecutandose
echo :: ============================================================
...
echo.
echo :: ============================================================
echo :: FASE 3: Iniciar servidor PHP en segundo plano
echo :: ============================================================
...
echo.
echo :: Iniciar servidor sin ventana visible
...
echo.
echo :: Esperar y verificar que inicio correctamente
...
(
echo ' MiSocio Printer - Lanzador Silencioso
echo ' Ejecuta el script BAT de forma completamente oculta
...
echo @echo off
echo :: ============================================================
echo :: Desinstalador MiSocio Printer
echo :: Elimina el servicio de inicio automatico
echo :: ============================================================
echo.
echo echo.
echo echo  ============================================
...
:: ============================================================
echo.
echo  [8/9] Configurando inicio automático con Windows...
